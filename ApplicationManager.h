...
#include "Statements/EndStatement.h"
#include "Statements/OperatorAssign.h"
#include "Statements/ReadStatement.h"
#include "Statements/StartStatement.h"
...
public:	
	...
	virtual void AddConnector(Connector* pConn);    //Adds a new Connector to the Flowchart
	...
	//void SetConnectorClipboard(Connector*Conn);
	//Connector* GetConnectorClipboard();
	// == Interface Management Functions ==
	Input *GetInput() const;        //Return pointer to the input
	Output *GetOutput() const;      //Return pointer to the output
	void UpdateInterface() const;	//Redraws all the drawing window
	//void DeleteStatement(Statement* DeleteStat);
	//void DeleteConnector(Connector* DeleteConn);
	int GetStatCount();
	int GetConnCount();
